...
sed -i 's/ff1c1b22/ff15141a/g' patched/smali*/mozilla/components/ui/colors/PhotonColors.smali
...
sed -i 's/ff52525e/ff15141a/g' patched/smali*/mozilla/components/ui/colors/PhotonColors.smali
